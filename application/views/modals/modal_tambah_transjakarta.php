<div class="col-md-offset-1 col-md-10 col-md-offset-1 well">
  ...
  <form id="form-tambah-transjakarta" method="POST" action="<?= base_url('transjakarta/prosestambah') ?>">
  <div class="alert alert-danger"><?= $this->session->flashdata('message'); ?></div>
    ...
    <div class="input-group form-group">
      ...
      <input type="text" class="form-control" placeholder="Nama Halte" name="nama" aria-describedby="sizing-addon2">
    </div>
