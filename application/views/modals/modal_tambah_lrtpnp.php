...
>>>>>>> 28c79abe5e7e997bdcec84fa42eed627bf20136e
  <div class="alert alert-danger"><?= $this->session->flashdata('message'); ?></div>
    <div class="input-group form-group">
      ...
      <input type="text" class="form-control" placeholder="Register" name="id" value="<?php echo getId('lrtpnp','id'); ?>" aria-describedby="sizing-addon2">
    </div>
    ...
    <div class="input-group form-group">
      ...
      <div class="col-md-12">
           <?php
              echo cmb_dinamis('id_stasiun', 'lrt', 'nama', 'id');
